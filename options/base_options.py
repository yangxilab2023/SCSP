...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #############################5.14
        parser.add_argument('--netA', type=str, default='resnet_3blocks', choices=['resnet_1blocks', 'resnet_3blocks', 'resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        
        parser.add_argument('--n_layers_D', type=int, default=3, help='only used if netD==n_layers')
        parser.add_argument('--normG', type=str, default='instance', choices=['instance', 'batch', 'none'], help='instance normalization or batch normalization for G')
        parser.add_argument('--normD', type=str, default='instance', choices=['instance', 'batch', 'none', 'SN'], help='instance normalization or batch normalization for D')
